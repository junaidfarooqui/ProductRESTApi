...
class Products
{
    ...
    public function readOne($code)
    {
        ...
        $response['productLine'] = $row['productLine'];
        $response['productScale'] = $row['productScale'];
        $response['productVendor'] = $row['productVendor'];
        $response['productDescription'] = $row['productDescription'];
        $response['quantityInStock'] = $row['quantityInStock'];
        $response['buyPrice'] = $row['buyPrice'];
        $response['MSRP'] = $row['MSRP'];
